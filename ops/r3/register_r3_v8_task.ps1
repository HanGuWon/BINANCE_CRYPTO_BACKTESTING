...
try {
    ...
    $action = New-ScheduledTaskAction -Execute 'powershell.exe' -Argument ('-NoProfile -ExecutionPolicy Bypass -File "' + $Launcher + '" -Persistent -PollSeconds 300') -WorkingDirectory $RepoRoot
